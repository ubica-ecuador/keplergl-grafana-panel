...
| thrift (the Apache Thrift Node.js library, under `@loaders.gl/parquet`)                                                                                                                                                               | 0.23.0          | Apache-2.0           | Copyright (C) 2006 - 2019, The Apache Software Foundation                                                           |
...
| @vis.gl/react-maplibre                                                                                                                                                                                                                | 8.1.3           | MIT                  | Copyright Vis.gl contributors.                                                                                      |
| maplibre-gl                                                                                                                                                                                                                           | 6.11.1          | BSD-3-Clause         | Copyright (c) 2023, MapLibre contributors                                                                           |
...
loaders.gl package around it is not its licence, and the row takes the SPDX header of those files. On
2026-09-23 the `xlsx` row went again, because kepler's Excel loader is now replaced by a stub
(`stubs/loaders-gl-excel`) and SheetJS is no longer bundled; `maplibre-gl` moved to 6.11.1 and
`@vis.gl/react-maplibre` to 8.1.3, both notices re-read and unchanged; and `thrift`, bundled all along
through loaders.gl's Parquet reader but missing from the table, got a row of its own. The
