...
ships.** The setting survives as a constant and a type in kepler 3.3.0-alpha.10, but no layer
...
Written against **kepler.gl 3.3.0-alpha.10**, which is what this plugin bundles. kepler's public
