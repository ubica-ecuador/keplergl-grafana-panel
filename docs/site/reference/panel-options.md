...
| Minimum interval while playing | `publishIntervalMs`   | `1500`                | **Only shown when `publishWhilePlaying` is on.** Least time between two writes during playback, 250 ms and up. See [Time window variables](../guide/dashboard/time-window-variables).                                                                                                                                                                                                                                                                                                                                |
