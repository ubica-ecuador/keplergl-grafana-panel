...
The mapping below was read out of the **installed** `@kepler.gl/layers` 3.3.0-alpha.13 and
...
constant and a TypeScript type in kepler 3.3.0-alpha.13, and no layer declares or reads it.
