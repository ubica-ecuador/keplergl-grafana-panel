...
export const FLOW_FIELD_MESSAGES: Record<string, string> = {
  ...
  'flowfield.zoomResponse': 'Zoom response (0 screen, 1 field)',
  ...
  'flowfield.fixedSpeedRange': 'Fixed speed range',
  'flowfield.widthBySpeed': 'Width by speed',
  'flowfield.widthRange': 'Width range (px)',
  'flowfield.opacityBySpeed': 'Opacity by speed',
  'flowfield.calmOpacity': 'Opacity in calm air',
